...
typedef enum {
  ...
  DISPATCHER_NEXT_PROTOCOL_17,
  DISPATCHER_NEXT_PROTOCOL_18,
  DISPATCHER_NEXT_PROTOCOL_19,
  DISPATCHER_NEXT_PROTOCOL_20,
  DISPATCHER_NEXT_PROTOCOL_21,
  DISPATCHER_NEXT_PROTOCOL_22,
  DISPATCHER_NEXT_PROTOCOL_23,
  DISPATCHER_NEXT_PROTOCOL_24,
  DISPATCHER_NEXT_PROTOCOL_25,
  DISPATCHER_NEXT_PROTOCOL_26,
  DISPATCHER_NEXT_PROTOCOL_27,
  DISPATCHER_NEXT_PROTOCOL_28,
  DISPATCHER_NEXT_PROTOCOL_29,
...
VLIB_REGISTER_NODE(dispatcher_node) = {
    ...
    .next_nodes = {[DISPATCHER_NEXT_PROTOCOL_1] = "protocol1",
                   ...
                   [DISPATCHER_NEXT_PROTOCOL_17] = "protocol17",
                   [DISPATCHER_NEXT_PROTOCOL_18] = "protocol18",
                   [DISPATCHER_NEXT_PROTOCOL_19] = "protocol19",
                   [DISPATCHER_NEXT_PROTOCOL_20] = "protocol20",
                   [DISPATCHER_NEXT_PROTOCOL_21] = "protocol21",
                   [DISPATCHER_NEXT_PROTOCOL_22] = "protocol22",
                   [DISPATCHER_NEXT_PROTOCOL_23] = "protocol23",
                   [DISPATCHER_NEXT_PROTOCOL_24] = "protocol24",
                   [DISPATCHER_NEXT_PROTOCOL_25] = "protocol25",
                   [DISPATCHER_NEXT_PROTOCOL_26] = "protocol26",
                   [DISPATCHER_NEXT_PROTOCOL_27] = "protocol27", 
                   [DISPATCHER_NEXT_PROTOCOL_28] = "protocol28",
                   [DISPATCHER_NEXT_PROTOCOL_29] = "protocol29",
