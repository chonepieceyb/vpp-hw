...
static u8 *format_intel_core_cache_detail(u8 *s, va_list *args) {
...
PERFMON_REGISTER_BUNDLE(intel_core_cache_detail) = {
    .name = "cache-detail",
    .description = "cache misses detail",
    .source = "intel-core",
    .type = PERFMON_BUNDLE_TYPE_NODE,

    .events[0] = INTEL_CORE_E_ICACHE_MISS,
    .events[1] = INTEL_CORE_E_L1D_REPLACEMENT,
    .events[2] = INTEL_CORE_E_MEM_LOAD_RETIRED_L2_MISS,
    .events[3] = INTEL_CORE_E_MEM_LOAD_RETIRED_L3_MISS,
    .n_events = 4,
    .format_fn = format_intel_core_cache_detail,
    .column_headers = PERFMON_STRINGS("L1I miss/pkt", "L1D miss/pkt",
                                      "L2 miss/pkt", "L3 miss/pkt"),
};
